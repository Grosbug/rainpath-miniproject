import { z } from 'zod'
import { EmailParams, SmsParams, WhatsAppParams, PostalParams } from './node-data'

export const NodeTemplateKind = z.enum(['send_email', 'send_sms', 'send_whatsapp', 'send_postal'])
